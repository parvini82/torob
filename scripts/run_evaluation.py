...
#     time.sleep(20)  # Sleep for 20s between requests
#
#     try:
#         # TODO: Replace this with your actual model implementation
#         # This is just a placeholder that returns empty results
...
#         output_model = run_langgraph_on_url(image_url)
#
#         # Check if output_model is None or empty
#         if not output_model:
#             print(f"Warning: run_langgraph_on_url returned empty/null result for {image_url}")
#             return []
#
#         # Check if 'persian' key exists
#         if 'persian' not in output_model:
#             print(f"Warning: 'persian' key not found in model output for {image_url}")
#             return []
#
#         # Check if 'entities' key exists in persian section
#         persian_section = output_model.get("persian")
#         if not persian_section or 'entities' not in persian_section:
#             print(f"Warning: 'entities' key not found in persian section for {image_url}")
#             return []
#
#         entities = persian_section.get("entities")
#
#         # Check if entities is a valid list
#         if not isinstance(entities, list):
#             print(f"Warning: entities is not a list for {image_url}, got: {type(entities)}")
#             return []
#
#         return entities
#
